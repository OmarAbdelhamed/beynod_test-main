...
const Welcome2Screen = ({ navigation }) => {
  ...
  >
    ...
    <Image source={require('../assets/Images/Rectangle 4 (1).png')} 
    ...
    />
      ...
      >Personalized Discount Alerts</Text>
      <Text
        style={{
          color: 'rgba(0, 0, 0, 1)',
          fontSize: 13,
...
Receive notifications for discounts and promotions based on your shopping history and preferences, ensuring you never miss out on great deals.        </Text>
    ...
    <CommonBtn
        ...
        handdleClick={() => navigation.navigate('welcome3')}
